$(function() {
    ...
    var fields = [{
            ...
            field: "countString",
            formatter: function(v, data) {
                return moneyFormat(data.tradeOrder.countString, '', data.tradeOrder.tradeCoin) + Dict.getNameForList1("coin",'',data.tradeOrder.tradeCoin);
            },
            readonly: true
        }, {
            title: "交易金额",
            ...
            columns: [{
                ...
                title: '业务类型',
                type: 'select',
                key: 'jour_biz_type_plat_usdt',
                formatter: Dict.getNameForList('jour_biz_type_plat_usdt'),
                search: true
            }, {
